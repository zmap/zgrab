...
zgrab_http_headers = SubRecord({
    "accept": ListOf(String()),
    "accept_charset": ListOf(String()),
    "accept_encoding": ListOf(String()),
    "accept_language": ListOf(String()),
    ...
    "from": ListOf(String()),
    "host": ListOf(String()),
    "if_match": ListOf(String()),
    "if_modified_since": ListOf(String()),
    "if_none_match": ListOf(String()),
    "if_unmodified_since": ListOf(String()),
    "last_modified": ListOf(String()),
    "link": ListOf(String()),
    "location": ListOf(String()),
    "max_forwards": ListOf(String()),
    "p3p": ListOf(String()),
    "pragma": ListOf(String()),
    "proxy_agent": ListOf(String()),
    "proxy_authenticate": ListOf(String()),
    "proxy_authorization": ListOf(String()),
